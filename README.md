...
정보 밀도가 높고 상황 변화가 빠른 간호사의 업무 환경 속에서, 방대한 업무 지침서는 필요한 내용을 빠르게 찾기 어렵고, 검색어를 정확히 모르면 관련 문서를 놓치기 쉽습니다. NurPT는 실무자가 자연어로 질문하면 관련 문서 조각을 먼저 찾고, LLM이 검색된 근거 안에서만 간결하게 답하도록 설계했습니다.
